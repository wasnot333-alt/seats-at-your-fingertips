          ...
          <TabsContent value="bookings">
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="glass-card flex items-center gap-4">
                <div className="p-4 rounded-xl bg-accent/10"><Users className="w-8 h-8 text-accent" /></div>
                <div><p className="text-sm text-muted-foreground">Total Seats</p><p className="text-3xl font-display font-bold text-foreground">{stats.total}</p></div>
              </div>
              <div className="glass-card flex items-center gap-4">
                <div className="p-4 rounded-xl bg-seat-available/10"><Ticket className="w-8 h-8 text-seat-available" /></div>
                <div><p className="text-sm text-muted-foreground">Booked</p><p className="text-3xl font-display font-bold text-foreground">{stats.booked}</p></div>
              </div>
              <div className="glass-card flex items-center gap-4">
                <div className="p-4 rounded-xl bg-primary/10"><Clock className="w-8 h-8 text-primary" /></div>
                <div><p className="text-sm text-muted-foreground">Available</p><p className="text-3xl font-display font-bold text-foreground">{stats.available}</p></div>
              </div>
            </div>
            ...
            <div className="glass-card overflow-hidden p-0">
              {loading ? (
                ...
                <div className="text-center py-20"><Search className="w-12 h-12 text-muted-foreground mx-auto mb-4" /><p className="text-lg font-medium text-foreground">No bookings found</p><p className="text-muted-foreground">Try adjusting your search or filter</p></div>
              ) : (
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border bg-secondary/30">
                        ...
                        <th className="text-left px-6 py-4 font-semibold text-foreground hidden xl:table-cell">Booking Time</th>
